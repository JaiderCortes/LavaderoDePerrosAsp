<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="lav_emp.aspx.vb" Inherits="Lavadero_de_perros.lav_emp" %>
...
<head runat="server">
    ...
    <title>Don perro (Lavado_empleado)</title>
    <!--Google fonts-->
    ...
    <!--Icon-->
    <link rel="icon" href="Iconos/empleado_lavado.ico" />
</head>
<body>
            ...
            <div class="row">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="lav_emp.aspx">
                                    <i class="fas fa-bath"></i>
                                    <font style="vertical-align: inherit">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Lavado_empleado</h1>
                        <p>
                            En esta página podrá hacer el manejo de la tabla lavado_empleado para cada lavado y empleado, haciendo inserción, actualización y eliminación de datos.
                        </p>
                        <!--Cajas de texto-->
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="idLavemp" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col col-text">
                                    Hora:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="horLavemp" runat="server" Enabled="true" uk-tooltip="Formato: 00:00"> </asp:TextBox><asp:RequiredFieldValidator ID="reqHor" runat="server" ControlToValidate="horLavemp" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-text">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="fechLavemp" runat="server" Enabled="true" uk-tooltip="Formato: dd/mm/aaaa"> </asp:TextBox><asp:RequiredFieldValidator ID="reqFech" runat="server" ControlToValidate="fechLavemp" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col col-text">
                                    Id_lavado:
                                </div>
                                <div class="col">
                                    <asp:DropDownList ID="ddIdlav" runat="server" Enabled="true"> </asp:DropDownList><asp:RequiredFieldValidator ID="reqIdlav" runat="server" ControlToValidate="ddIdlav" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-text">
                                ...
                                <div class="col">
                                    <asp:DropDownList ID="ddIdemp" runat="server" Enabled="true"> </asp:DropDownList><asp:RequiredFieldValidator ID="reqIdemp" runat="server" ControlToValidate="ddIdemp" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="infoPag" uk-offcanvas="flip: true; overlay: true">
                        <div class="uk-offcanvas-bar">
                            ...
                            tenga la posibilidad de editar información de los empleados registrados en el sitio web de la empresa, de tal modo que se 
