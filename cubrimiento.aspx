<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cubrimiento.aspx.vb" Inherits="Lavadero_de_perros.cubrimiento" %>
...
<head runat="server">
    ...
    <title>Don perro (Empleado)</title>
    <!--Google fonts-->
    ...
    <!--Icon-->
    <link rel="icon" href="Iconos/empleado.ico" />
</head>
<body>
            ...
            <div class="row">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="cubrimiento.aspx">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Cubrimiento</h1>
                        <p>
                            En esta página podrá hacer el manejo de la tabla Cubrimiento para cada cliente, haciendo inserción, actualización y eliminación de datos.
                        </p>
                        <!--Cajas de texto-->
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="idCub" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col col-text">
                                    Empleado que cubre:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="empCub" runat="server" Enabled="true"> </asp:TextBox><asp:RequiredFieldValidator ID="reqEmp" runat="server" ControlToValidate="empCub" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-text">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="motCub" runat="server" Enabled="true" TextMode="MultiLine"> </asp:TextBox><asp:RequiredFieldValidator ID="reqMot" runat="server" ControlToValidate="motCub" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col col-text">
                                    Fecha:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="fechCub" runat="server" Enabled="true" TextMode="Date"> </asp:TextBox><asp:RequiredFieldValidator ID="reqFech" runat="server" ControlToValidate="fechCub" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-text">
                                ...
                                <div class="col">
                                    <asp:DropDownList ID="ddEmp" runat="server" Enabled="true"> </asp:DropDownList><asp:RequiredFieldValidator ID="ddEmpC" runat="server" ControlToValidate="ddEmp" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="infoPag" uk-offcanvas="flip: true; overlay: true">
                        <div class="uk-offcanvas-bar">
                            ...
                            tenga la posibilidad de editar información de los cubrimientos realizados por cada empleado en el sitio web de la empresa, de tal modo que se 
