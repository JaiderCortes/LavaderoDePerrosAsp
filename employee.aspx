<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="employee.aspx.vb" Inherits="Lavadero_de_perros.employee" %>
            ...
            <div class="row">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="employee.aspx">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <p>
                            En esta página podrá hacer el manejo de la tabla Empleado, haciendo inserción, actualización y eliminación de datos.
                        </p>
                        <!--Cajas de texto-->
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="idEmp" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col col-text">
                                    Nombre:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="nomEmp" runat="server" Enabled="true"> </asp:TextBox><asp:RequiredFieldValidator ID="reqNom" runat="server" ControlToValidate="nomEmp" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-text">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="nacEmp" runat="server" Enabled="true" TextMode="Date"> </asp:TextBox><asp:RequiredFieldValidator ID="reqNac" runat="server" ControlToValidate="nacEmp" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col col-text">
                                    Email:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="emaEmp" runat="server" Enabled="true"> </asp:TextBox><asp:RequiredFieldValidator ID="reqEma" runat="server" ControlToValidate="emaEmp" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
