<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="perro.aspx.vb" Inherits="Lavadero_de_perros.perro" %>
...
<head runat="server">
    ...
    <!--Icon-->
    <link rel="icon" href="Iconos/perro.ico" />
</head>
<body>
            ...
            <div class="row">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="perro.aspx">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Perro</h1>
                        <p>
                            En esta página podrá hacer el manejo de la tabla Perro para cada cliente, haciendo inserción, actualización y eliminación de datos.
                        </p>
                        <!--Cajas de texto-->
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="idPerr" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col col-text">
                                    Nombre:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="nomPerr" runat="server" Enabled="true"> </asp:TextBox><asp:RequiredFieldValidator ID="reqNom" runat="server" ControlToValidate="nomPerr" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-text">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="descPerr" runat="server" Enabled="true" TextMode="MultiLine"> </asp:TextBox><asp:RequiredFieldValidator ID="reqDesc" runat="server" ControlToValidate="descPerr" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col col-text">
                                    Año de nacimiento:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="nacPerr" runat="server" Enabled="true" TextMode="Date"> </asp:TextBox><asp:RequiredFieldValidator ID="reqAño" runat="server" ControlToValidate="nacPerr" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-text">
                                ...
                                <div class="col">
                                    <asp:DropDownList ID="ddIdCli" runat="server" Enabled="true"></asp:DropDownList> <asp:RequiredFieldValidator ID="reqIdcli" runat="server" ControlToValidate="ddIdCli" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="infoPag" uk-offcanvas="flip: true; overlay: true">
                        <div class="uk-offcanvas-bar">
                            ...
                            tenga la posibilidad de editar información de los perros registrados por cada cliente en el sitio web de la empresa, de tal modo que se 
