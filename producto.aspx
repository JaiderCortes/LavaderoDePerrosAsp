<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="producto.aspx.vb" Inherits="Lavadero_de_perros.producto" %>
...
<head runat="server">
    ...
    <title>Don perro (Producto)</title>
    <!--Google fonts-->
    ...
    <!--Icon-->
    <link rel="icon" href="Iconos/producto.ico" />
</head>
<body>
            ...
            <div class="row">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="producto.aspx">
                                    <i class="fas fa-shopping-bag"></i>
                                    <font style="vertical-align: inherit">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <p>
                            En esta página podrá hacer el manejo de la tabla Producto, haciendo inserción, actualización y eliminación de datos.
                        </p>
                        <!--Cajas de texto-->
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="idProd" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col col-text">
                                    Nombre:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="nomProd" runat="server" Enabled="true"> </asp:TextBox><asp:RequiredFieldValidator ID="reqNom" runat="server" ControlToValidate="nomProd" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="infoPag" uk-offcanvas="flip: true; overlay: true">
                        <div class="uk-offcanvas-bar">
                            ...
                            tenga la posibilidad de editar información de los productos registrados por cada cliente en el sitio web de la empresa, de tal modo que se 
