<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="prod_lav.aspx.vb" Inherits="Lavadero_de_perros.prod_lav" %>
...
<head runat="server">
    ...
    <title>Don perro (Productos_lavado)</title>
    <!--Google fonts-->
    ...
    <!--Icon-->
    <link rel="icon" href="Iconos/producto_lavado.ico" />
</head>
<body>
            ...
            <div class="row">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="prod_lav.aspx">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Producto_lavado</h1>
                        <p>
                            En esta página podrá hacer el manejo de la tabla Productos_lavado con las tablas producto y lavado, haciendo inserción, actualización y eliminación de datos.
                        </p>
                        <!--Cajas de texto-->
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="idProdlav" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col col-text">
                                    Precio:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="precProdlav" runat="server" Enabled="true"> </asp:TextBox><asp:RequiredFieldValidator ID="reqPrecProdlav" runat="server" ControlToValidate="precProdlav" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-text">
                                ...
                                <div class="col">
                                    <asp:DropDownList ID="ddIdprod" runat="server" Enabled="true"></asp:DropDownList> <asp:RequiredFieldValidator ID="reqIdprod" runat="server" ControlToValidate="ddIdprod" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="infoPag" uk-offcanvas="flip: true; overlay: true">
                        <div class="uk-offcanvas-bar">
                            ...
                            tenga la posibilidad de editar información de los productos_lavados para cada producto y cada lavado en el sitio web de la empresa, de tal modo que se 
