<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="lavado.aspx.vb" Inherits="Lavadero_de_perros.lavado" %>
...
<head runat="server">
    ...
    <!--Icon-->
    <link rel="icon" href="Iconos/lavado.ico" />
</head>
<body>
            ...
            <div class="row">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="lavado.aspx">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Lavado</h1>
                        <p>
                            En esta página podrá hacer el manejo de la tabla Lavado para cada perro, haciendo inserción, actualización y eliminación de datos.
                        </p>
                        <!--Cajas de texto-->
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="idLav" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col col-text">
                                    Código batea:
                                </div>
                                <div class="col">
                                    <asp:TextBox ID="codbLav" runat="server" Enabled="true" uk-tooltip="5 números (según la cadena que se lleva)"> </asp:TextBox><asp:RequiredFieldValidator ID="reqCodb" runat="server" ControlToValidate="codbLav" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-text">
                                ...
                                <div class="col">
                                    <asp:DropDownList ID="ddIdPerr" runat="server" Enabled="true"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="reqIdPerr" runat="server" ControlToValidate="ddIdPerr" ErrorMessage="RequiredFieldValidator" ForeColor="red" CssClass="valid">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="infoPag" uk-offcanvas="flip: true; overlay: true">
                        <div class="uk-offcanvas-bar">
                            ...
                            tenga la posibilidad de editar información de los lavados registrados por cada cliente en el sitio web de la empresa, de tal modo que se 
